                        ...
                        <div class="row">
                            <div class="col-lg-12 mx-auto">
                                <div class="p-5">
                                    ...
                                    <form dir="rtl" class="user" action="{{ route("check") }}" method="POST">
                                        @method("post")
                                        @csrf
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{ route("register") }}" >انا لا امتلك حساب</a>
                                        <a class="small d-block m-3" href="{{ route("home") }}" >العودة الى الصفحة الرايسية</a>
                                    </div>
                                </div>
                            </div>
                        </div>
